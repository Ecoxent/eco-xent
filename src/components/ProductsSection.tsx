...
const products: Product[] = [
  {
    ...
    description: "A therapeutic botanical serum crafted to heal sun-damaged and dull skin. Restores natural radiance while forming a protective shield against environmental stress.",
  ...
  },
  {
    ...
    description: "A powerful healing blend of 13+ therapeutic oils that repairs damaged scalp, strengthens weak follicles, and revives hair from root to tip for visibly healthier growth.",
  ...
  },
  {
    ...
    description: "A sulfate-free healing formula that gently removes buildup and toxins while preserving your scalp's natural oils. Ideal for chemically treated or weakened hair.",
  ...
  },
  {
    ...
    description: "Handcrafted with organic healing herbs, this soap draws out impurities and soothes irritated skin. Designed to restore your skin's natural balance without harsh chemicals.",
  ...
  },
  {
    ...
    description: "A deeply nourishing herbal conditioner that heals dry, brittle ends and locks in moisture. Transforms rough, lifeless hair into soft, salon-quality silk after every wash.",
  ...
  },
  {
    ...
    description: "A clinical-grade healing serum with Niacinamide, Vitamin C, Kojic Acid & Alpha Arbutin. Targets melasma, dark spots, and fine lines for a visibly even, youthful complexion.",
  ...
  },
  {
    ...
    description: "A luxury healing soap infused with botanical oils that deeply cleanses pores while repairing dry, rough skin. Leaves your body feeling silky smooth and naturally refreshed.",
