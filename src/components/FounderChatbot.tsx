...
import { X, Send, User, Loader2, Brain } from "lucide-react";
...
const WELCOME_MSG: Msg = {
  role: "assistant",
  content: "Assalam o Alaikum! 🧠✨ Main founder ki AI assistant hoon. Aap mujh se NLP, Silva Method, trauma healing, ya coaching ke baare mein kuch bhi pooch sakte hain — kisi bhi language mein! Kya madad kar sakti hoon?",
};
...
const FounderChatbot = () => {
  ...
  return (
    <>
      {/* Toggle button - brain icon for founder */}
      <AnimatePresence>
        {!isOpen && (
          <motion.button
            initial={{ scale: 0 }}
            ...
            className="fixed bottom-24 right-6 z-50 w-14 h-14 rounded-full flex items-center justify-center shadow-xl border-2 border-gold/30 ring-2 ring-gold/10 ring-offset-2 transition-all duration-300"
          ...
          >
            ...
            >
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-full flex items-center justify-center bg-white/10 border border-gold/30">
